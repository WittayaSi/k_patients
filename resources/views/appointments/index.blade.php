...
<div class="container">
    <div id="vueApp">
        ...
        <div class="modal fade" ref="modalAppointment" id="modalAppointment_c" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <!-- Modal Add Appointment-->
        <div class="modal fade" ref="modalAppointment" id="modalEditApp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <form action="#" @submit.prevent="addNewAppoint">
            {{ csrf_field() }}
            <div class="modal-dialog">
                <div class="modal-content">
                ...
                <div id="calendar">
                    <center>
                        <a data-toggle="modal" data-target="#modalAppointment_c" class="btn btn-primary">
                            <i class="fa fa-address-book fa-fw"></i> นัดหมายเพิ่ม
                        </a>
                    </center>
                    {!! $calendar->calendar() !!}
                    {!! $calendar->script() !!}
